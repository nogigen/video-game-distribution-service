    ...
    <div class="container">
        ...
        <div id="centerwrapper">
            ...
            <?php
                ...
                $curatorName = $_SESSION['curator_name'];
                ...
                //GET REVIEW TEXT
                $queryGameId = "SELECT * FROM curatorreview NATURAL JOIN publish WHERE curator_id = '$curatorId' AND game_id = '$gameId'";
                $result = mysqli_query($db, $queryGameId);
                $gameIdRow = mysqli_fetch_array($result);
                $review_desc = $gameIdRow['c_review_text'];
