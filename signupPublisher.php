...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO publisher(publisher_login_name, publisher_email, publisher_password, publisher_name) VALUES (?, ?, ?, ?)";
        ...
        <div id="centerwrapper">
            <div id="centerdiv">
                ...
                <form action="">
                    ...
                    <input type="radio" name="user_type" value="publisher" checked="checked"> Publisher
                ...
                <form id="signupForm" action="" method="post">
                    <div class="form-group">
                        <label>Publisher Login Name</label>
