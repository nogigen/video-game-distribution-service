...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if(isset($_POST['seereviews'])) {

        $_SESSION["selected_review_id"] = $_POST['seereviews'];
        $reviewId = $_SESSION["selected_review_id"];

        header("location: userSeeReviewsDetails.php");
...
<body>
    ...
    <div class="container">
        ...
        <div id="centerwrapper">
            <div id="centerdiv">
            <br><br>
                <h1>Reviewes of <?php echo htmlspecialchars($_SESSION['selected_game_name']); ?> </h1>
                ...
                <form id="gameForm" action="" method="post">
                    ...
                    <?php
                        ...
                        $query = "SELECT nick_name, review_id FROM person NATURAL JOIN game NATURAL JOIN review NATURAL JOIN personreview WHERE game_id = '$gameId'";
                        ...
                        <select id = \"filterType\">
                            <option value =\"filterNickName\" selected=\"selected\">Nick Name</option>
                        </select>
                        ...
                        while($row = mysqli_fetch_array($result)) {
                            ...
                            echo "<td>
                            <button onclick=\"cancelled()\" name = \"seereviews\"class=\"btn btn-primary btn-sm\" value ='".$row['review_id'] ."'>REVIEW DETAILS</button>
                            </td>";
