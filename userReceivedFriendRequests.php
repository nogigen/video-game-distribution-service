...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if(isset($_POST['seemore'])) {
        ...
        header("location: userReceiveFriendshipDecision.php");
    }
            ...
            <div id="centerdiv">
                ...
                <h1>Received Friend Requests</h1>
                    ...
                    <?php
                        ...
                        $query = "SELECT person_id1, relationship_status, friendship_id FROM relationship WHERE person_id2 = '$user_id'";
